...
| Docs   | Rich content in header/footer/footnote segments       | Stable with segment constraints                              | Implemented first pass with unsupported constructs rejected                              |
...
| Slides | Core creation, reading, editing, media, tables, notes | Stable                                                       | Initial tool group plus thumbnails, speaker notes, tables, and Sheets charts implemented |
